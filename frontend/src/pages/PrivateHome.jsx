        ...
        >
          <div>
            ...
            >
              ...
              and monitor progress with a polished SaaS-style experience.
            </p>

            <div style={{ display: "flex", flexWrap: "wrap", gap: "1rem" }}>
              {[
                { label: "Explore Colleges", variant: "primary" },
                { label: "Start Quiz", variant: "secondary" },
                { label: "View Roadmaps", variant: "ghost" },
                { label: "AI Mentor", variant: "accent" },
              ].map((button) => (
                <button
                  key={button.label}
                  style={{
